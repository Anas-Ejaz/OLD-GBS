...
// Select all images within .socail_item elements
...
socialImages.forEach(img => {
  gsap.from(img, {
    duration: 1,
    opacity: 0,
    y: 50, // Animates the images from 50px below their original position
    stagger: 0.2, // Stagger the start time of each animation by 0.2 seconds
    ...
    scrollTrigger: {
      ...
      end: "top 50%", // End the animation when the top of the element reaches 50% of the viewport height
      toggleActions: "play none none none", // Play the animation when in view, do nothing otherwise
