...
socialImages.forEach(img => {
  gsap.from(img, {
    ...
    x: -100, // Start from 100px left of its position
    rotation: 360, // Start with 360 degrees rotation
    stagger: 0.2, // Stagger start of animation for each image
    ...
    scrollTrigger: {
      ...
      end: "top 50%", // End the animation when the top of the image reaches 50% of the viewport height
      scrub: true, // Allows the animation to sync with the scrollbar
